  ...
  if (!ready) {
    return (
      <div className="w-full max-w-md text-center">
        <p className="text-text-muted font-body text-sm animate-pulse">Verifying link…</p>
      </div>
    );
  }
  ...
  return (
    <div className="relative w-full max-w-md">
      <div className="text-center mb-10">
        ...
        <p className="mt-4 text-text-muted font-body text-sm">Set a new password</p>
      </div>
...
export default function ResetPasswordPage() {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      ...
      <Suspense fallback={<p className="text-text-muted font-body text-sm animate-pulse">Loading…</p>}>
        <ResetPasswordForm />
      </Suspense>
    </div>
  );
